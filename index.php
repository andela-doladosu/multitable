...
<tr>
    ...
    <td><input type="number" name="vertical_start" value="<?php echo $_SESSION['v_start'] ?>">
    </td>
    <td><span class="text">To:</span>
    </td>
    <td><input type="number" name="vertical_stop" value="<?php echo $_SESSION['v_stop'] ?>">
    </td>
</tr>
</table>
...
<tr>
    ...
    <td><input type="number" name="horizontal_start" value="<?php echo $_SESSION['h_start'] ?>">
    </td>
    <td><span class="text">To:</span>
    </td>
    <td><input type="number" name="horizontal_stop" value="<?php echo $_SESSION['h_stop'] ?>">
    </td>
</tr>
</table>
